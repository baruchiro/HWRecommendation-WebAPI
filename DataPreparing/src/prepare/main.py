...
from transformers import extract_ddr_from_gpu_processor, convert_disk_capacity_to_byte, convert_memory_capacity_to_byte, convert_processor_ghz_to_mhz, remove_unwanted_chars_in_processor_name
